...
import './App.css';   //vs komponent si vyrvi sus css-a

import NavigationBar from './Components/NavigationBar';   //s CTRL stavat hiperlinkove
...
export default class App extends Component {        //exportva App s ime App
    constructor(props) {
        super(props);
        this.state = {                                   //!!! komunikaciq m/u komponenti
    ...
    render() {
        return (
            <div className="App">
                <header>
                    <NavigationBar                    //ot class NavigationBar
                        username={this.state.username}              //bindvame app s navigationBar child!!
                        homeClicked={this.showHomeView.bind(this)}   //bindvame tekushtiq this
                        loginClicked={this.showLoginView.bind(this)} //methodi otdolu
    ...
    componentDidMount() {             // se 1 onload za component
    ...
    showView(reactViewComponent) {            //rendira viewto
    ...
    showHomeView() {
        this.showView(<HomeView username={this.state.username} />);   //podava na viewto suotvetnata stranica
    }
